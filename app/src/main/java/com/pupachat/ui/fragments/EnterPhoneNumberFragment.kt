...
class EnterPhoneNumberFragment : Fragment(R.layout.fragment_enter_phone_number) {
    ...
    private lateinit var mCallbeck: PhoneAuthProvider.OnVerificationStateChangedCallbacks


    override fun onStart() {
        super.onStart()
        mCallbeck = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
